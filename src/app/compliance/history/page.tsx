...
export default function ApprovalLogsPage() {
    ...
    const [activeTab, setActiveTab] = useState<'wallet' | 'disbursement'>('wallet');
    const [searchTerm, setSearchTerm] = useState('');
    const [selectedStatus, setSelectedStatus] = useState('all');
    const [showModal, setShowModal] = useState(false);
    const [selectedEntry, setSelectedEntry] = useState<WalletEntry | Disbursement | null>(null); 
    ...
    const disbursements: Disbursement[] = [
        {
            ...
            groupName: 'Premium Chit Fund Group B',
            requestedBy: 'Admin',
        ...
        },
        {
            ...
            groupName: 'Office Colleagues Chit Fund',
 ...
 const getStatusColor = (status: string) => {
   ...
   const filteredWalletEntries = walletEntries.filter(entry => {
    ...
    const filteredDisbursements = disbursements.filter(disbursement => {
        ...
        const matchesStatus = selectedStatus === 'all' || disbursement.status.toLowerCase() === selectedStatus.toLowerCase();
   ...
   // Calculate stats
    const approvedWalletEntries = walletEntries.filter(e => e.status === 'Approved').length;
    const rejectedWalletEntries = walletEntries.filter(e => e.status === 'Rejected').length;
    const approvedDisbursements = disbursements.filter(d => d.status === 'Approved').length;
    const rejectedDisbursements = disbursements.filter(d => d.status === 'Rejected').length;
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">
                                    {totalTransactions > 0 ? Math.round((totalApproved / totalTransactions) * 100) : 0}%
                                </p>
                            </div>
                    ...
                    <div className="border-b border-gray-200">
                        <nav className="flex space-x-8 px-6" aria-label="Tabs">
                            <button
                                ...
                                className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'wallet'
                            ...
                            <button
                                ...
                                className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'disbursement'
                                    ? 'border-blue-500 text-blue-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                    }`}
                            >
                                            ...
                                            <tr key={entry.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <div className="text-sm font-medium text-gray-900">{entry.walletId}</div>
                                                            <div className="text-sm text-gray-500">{entry.memberName} ({entry.memberId})</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div>
                                                        <div className={`text-sm font-medium ${entry.type === 'Credit' ? 'text-green-600' : 'text-red-600'
                                                            }`}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div>
                                                        <div className="text-sm font-medium text-gray-900">{entry.paymentMethod}</div>
                                                        {entry.bankName && (
                                                            <div className="text-sm text-gray-500">{entry.bankName}</div>
                                                        )}
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900">{formatDateTime(entry.approvedAt)}</div>
                                                </td>
                                            ...
                                            <tr key={disbursement.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <div className="text-sm font-medium text-gray-900">{disbursement.id}</div>
                                                            <div className="text-sm text-gray-500">{disbursement.description}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div>
                                                        <div className="text-sm font-medium text-gray-900">{disbursement.recipientName}</div>
                                                        <div className="text-sm text-gray-500">{disbursement.groupName}</div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-gray-500">{disbursement.type}</div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="space-y-1">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900">{formatDateTime(disbursement.approvedAt)}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <button
                            ...
                            {activeTab === 'wallet' && 'walletId' in selectedEntry ? (
                                <>
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-sm text-gray-900">{selectedEntry.walletId}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Member:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.memberName} ({selectedEntry.memberId})</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Amount:</span>
                                        <span className={`text-sm font-medium ${selectedEntry.type === 'Credit' ? 'text-green-600' : 'text-red-600'}`}>
                                            {selectedEntry.type === 'Credit' ? '+' : '-'}{formatCurrency(selectedEntry.amount)}
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Type:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.type}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Payment Method:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.paymentMethod}</span>
                                    </div>
                                    {selectedEntry.bankName && (
                                        <div className="flex justify-between">
                                            <span className="text-sm font-medium text-gray-500">Bank:</span>
                                            <span className="text-sm text-gray-900">{selectedEntry.bankName}</span>
                                        </div>
                                    )}
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Transaction Date:</span>
                                        <span className="text-sm text-gray-900">{formatDateTime(selectedEntry.transactionDate)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Created By:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.createdBy}</span>
                                    </div>
                                    <div className="flex justify-between">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-sm text-gray-900">{formatDateTime(selectedEntry.approvedAt)}</span>
                                    </div>
                                    {selectedEntry.description && (
                                        <div className="pt-2 border-t border-gray-200">
                                            <span className="text-sm font-medium text-gray-500">Description:</span>
                                            <p className="text-sm text-gray-900 mt-1">{selectedEntry.description}</p>
                                        </div>
                                    )}
                                </>
                            ) : activeTab === 'disbursement' && 'recipientName' in selectedEntry ? (
                                <>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">ID:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.id}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Recipient:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.recipientName}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Amount:</span>
                                        <span className="text-sm font-medium text-green-600">{formatCurrency(selectedEntry.amount)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Type:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.type}</span>
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-sm text-gray-900">{selectedEntry.groupName}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Requested:</span>
                                        <span className="text-sm text-gray-900">{formatDateTime(selectedEntry.requestedAt)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Requested By:</span>
                                        <span className="text-sm text-gray-900">{selectedEntry.requestedBy}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-sm font-medium text-gray-500">Status:</span>
                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(selectedEntry.status)}`}>
