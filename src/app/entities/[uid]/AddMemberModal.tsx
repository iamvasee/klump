...
export default function AddMemberModal({ entityId, isOpen, onClose, onSuccess }: AddMemberModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <h2 className="text-xl font-bold text-gray-900">Add Management Member</h2>
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-100 bg-gray-50/50">
          ...
          <PrimaryButton onClick={handleSubmit} disabled={isSubmitting || !personId || !role || !effectiveDate}>
