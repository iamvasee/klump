...
export default function UploadDocumentModal({
  ...
  const handleSubmit = () => {
    ...
    db.addDocument({
      ...
      file_path:
        'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf', // Mock path
    });
  ...
  const docTypeOptions = Object.entries(DOCUMENT_TYPE_LABELS).map(
    ([key, label]) => ({
      value: key,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          ...
          <div
            className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center bg-gray-50 hover:bg-blue-50 hover:border-blue-300 transition-colors cursor-pointer"
