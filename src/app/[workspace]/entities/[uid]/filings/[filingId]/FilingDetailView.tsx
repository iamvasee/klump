        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-2">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed italic">
                    &quot;{filing.description || 'No additional notes.'}&quot;
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                {filing.data &&
                  Object.entries(filing.data).map(([key, value]) => (
                    <div
                      key={key}
                ...
                {!filing.data && (
                  <p className="text-sm text-gray-400 italic">
                    No custom data points recorded for this filing.
                  </p>
                )}
              </div>
            </div>
              ...
              <div className="p-2 space-y-1">
                {filing.files.map((file) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <FileText
                        className={`w-5 h-5 ${selectedFile?.id === file.id ? 'text-blue-600' : 'text-gray-400'}`}
                      />
                    ...
                    <ChevronRight
                      className={`w-4 h-4 transition-transform ${selectedFile?.id === file.id ? 'translate-x-1' : 'opacity-0'}`}
                    />
                  </button>
                ))}
              </div>
            ...
            <div className="bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border-8 border-slate-900 h-[800px] flex flex-col relative">
              ...
              <div className="bg-slate-800 px-6 py-4 flex items-center justify-between border-b border-slate-700">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white text-sm font-bold truncate max-w-xs">
              ...
              <div className="absolute bottom-6 right-8 pointer-events-none opacity-20 select-none">
                <p className="text-4xl font-black text-white/10 tracking-widest uppercase -rotate-12">
                  KLUMP SECURE
                </p>
              </div>
            </div>
