...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`sidebar flex flex-col h-screen bg-white border-r border-gray-200/60 shadow-sm transition-all duration-300 ${
                ...
                >
                  <item.icon
                    className={`w-5 h-5 flex-shrink-0 transition-all duration-200 ${
                      isActive
                        ? 'text-white'
                        : 'text-gray-500 group-hover:text-gray-900 group-hover:scale-110'
                    }`}
                  />
                  {!isCollapsed && (
          ...
          >
            {isCollapsed ? (
              ...
              <>
                ...
                <span className="ml-2 font-medium group-hover:text-blue-600 transition-colors duration-200">
                  Collapse
                </span>
              </>
            )}
