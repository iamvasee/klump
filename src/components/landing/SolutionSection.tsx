          ...
          <div className="bg-white border border-gray-100 rounded-[3rem] p-10 sm:p-16 shadow-2xl shadow-gray-200/40 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-xl sm:text-2xl text-gray-700 leading-relaxed mb-10">
                Klump creates a{' '}
                <span className="font-black text-gray-900 underline decoration-indigo-500/20 underline-offset-8">structured memory layer</span>{' '}
                for high-stakes organizations.
              </p>

              <div className="flex items-center gap-3 mb-8">
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">The Catalog</span>
              ...
              <div className="space-y-6">
                <p className="text-xl text-gray-700 leading-relaxed">
                  …becomes{' '}
                  <span className="font-black text-gray-900 italic">permanently organized</span>,{' '}
                  <span className="font-black text-gray-900 underline decoration-blue-500/20">searchable</span>, and{' '}
                  <span className="font-black text-gray-900 tracking-tight">traceable</span>.
                </p>

                <div className="flex flex-wrap gap-8 pt-10 border-t border-gray-50">
                  {['Across entities.', 'Across teams.', 'Across generations.'].map((line) => (
                    <p key={line} className="text-sm font-black text-indigo-600 uppercase tracking-widest">{line}</p>
                  ))}
                </div>
              </div>
            </div>
